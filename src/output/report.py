# generate REPORT.md - the human-readable audit trail
...
def generate(
    ...
    # Without these, REPORT.md is a dead-end and the vault splits into disconnected components.
    if communities:
    ...
    lines += ["", "## Communities"]
    from aikgraph.core.analyze._filters import is_file_node as _ifn
    ...
    # --- Gaps section ---
    from aikgraph.core.analyze._filters import is_concept_node, is_file_node
