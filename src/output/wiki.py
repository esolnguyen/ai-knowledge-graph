...
def _community_article(
    ...
    lines += [
        "---",
        "",
        "*Part of the aikgraph knowledge wiki. See [[index]] to navigate.*",
    ]
    return "\n".join(lines)
...
def _index_md(
    ...
    lines: list[str] = [
        ...
        "",
        "> Auto-generated by aikgraph. Start here — read community articles for context, then drill into god nodes for detail.",
        "",
    ...
    lines += [
        "---",
        "",
        "*Generated by [aikgraph](https://github.com/safishamsi/aikgraph)*",
    ]
    return "\n".join(lines)
